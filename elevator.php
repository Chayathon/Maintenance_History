...
<body>
    ...
    <div class="md:container md:mx-auto px-2 py-4">
        <div class="card bg-base-100 drop-shadow-[0_15px_35px_rgba(0,0,0,0.25)]">
            <div class="card-body">
                <div class="flex">
                    <p class="font-bold text-xl text-center">ระบบลิฟต์ ตึกหน้า</p>
                </div>
                <div class="flex justify-end">
                    ...
                    <dialog id="add_modal" class="modal">
                        <div class="modal-box">
                            ...
                            <form name="add" id="add" method="post" enctype="multipart/form-data" action="elevator_db.php">
                                <script>
                            ...
                            <?php foreach($result as $row) { ?>
                                    ...
                                    <div class="modal-box w-11/12 max-w-5xl">
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <a class="hover:underline" href="images/eleavator/<?php echo $row['Detail']; ?>/quotation/<?php echo $row['Quotation']; ?>" target="_blank"><?php echo $row['Quotation']; ?></a>
                                            </div>
                                            <div>
                                                <p class="font-bold">วางบิล</p>
                                                <a class="hover:underline" href="images/eleavator/<?php echo $row['Detail']; ?>/bill/<?php echo $row['Bill']; ?>" target="_blank"><?php echo $row['Bill']; ?></a>
                                            </div>
                                        </div>

                                        <?php
                                            $targetFolder = $row['Detail'] . "-" . $row['Date'];
                                            $directory = "images/elevator/$targetFolder/more_pictures/";
                                ...
                                <dialog id="edit_modal<?php echo $row['ID']; ?>" class="modal">
                                    <div class="modal-box">
                                        ...
                                        <form name="edit" id="edit" method="post" enctype="multipart/form-data" action="elevator_db.php">
                                            <script>
                                                function formatDate(input) {
                                                    // แปลง format เป็น dd/mm/yyyy
                                                    var dateParts = input.value.split("-");
                                ...
                                <dialog id="delete_modal<?php echo $row['ID']; ?>" class="modal">
                                    <div class="modal-box">
                                        ...
                                        <form name="delete" id="delete" method="post" action="elevator_db.php">
