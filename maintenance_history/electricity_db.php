<?php
    ...
    if(isset($_POST['add'])) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['more_pic'])) {
            ...
            $targetDir = "images/electricity/$detail-$date/more_pictures/";
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['quotation'])) {
            ...
            $targetDir = "images/electricity/$detail-$date/quotation/";
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['bill'])) {
            ...
            $targetDir = "images/electricity/$detail-$date/bill/";
        ...
        $sql = "INSERT INTO `electricity`(`Date`, `Detail`, `Note`, `Quotation`, `Bill`, `By`, `Lastestdate`, `Time`) VALUES ('$date','$detail','$note','$fileNameQuotation','$fileNameBill','$name','$current_date','$current_time')";
    ...
    if(isset($_POST['edit'])) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['quotation']) && $_FILES['quotation']['error'] == UPLOAD_ERR_OK) {
            ...
            $sql = "UPDATE `electricity` SET `Quotation` = '$fileNameQuotation' WHERE `ID` = '$id'";
            $result = mysqli_query($con, $sql);
        }
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['bill']) && $_FILES['bill']['error'] == UPLOAD_ERR_OK) {
            ...
            $sql = "UPDATE `electricity` SET `Bill` = '$fileNameBill' WHERE `ID` = '$id'";
            $result = mysqli_query($con, $sql);
        }
        ...
        $sql = "UPDATE `electricity` SET `Date` = '$date',
                                        `Note` = '$note',
                                        `By` = '$name',
    ...
    if(isset($_POST['delete'])) {
        ...
        $targetDir = "images/electricity/$detail-$date/";

        deleteDirectory($targetDir);

        $sql = "DELETE FROM `electricity` WHERE `ID` = '$id'";
        $result = mysqli_query($con, $sql);
