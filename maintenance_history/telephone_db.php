<?php
    ...
    if(isset($_POST['add'])) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['more_pic'])) {
            ...
            $targetDir = "images/telephone/$detail-$date/more_pictures/";
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['quotation'])) {
            ...
            $targetDir = "images/telephone/$detail-$date/quotation/";
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['bill'])) {
            ...
            $targetDir = "images/telephone/$detail-$date/bill/";
        ...
        $sql = "INSERT INTO `telephone`(`Date`, `Detail`, `Brand`, `Amount`, `Price`, `Quotation`, `Bill`, `By`, `Lastestdate`, `Time`) VALUES ('$date','$detail','$brand','$amount','$price','$fileNameQuotation','$fileNameBill','$name','$current_date','$current_time')";
    ...
    if(isset($_POST['edit'])) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['quotation']) && $_FILES['quotation']['error'] == UPLOAD_ERR_OK) {
            ...
            $sql = "UPDATE `telephone` SET `Quotation` = '$fileNameQuotation' WHERE `ID` = '$id'";
            $result = mysqli_query($con, $sql);
        }
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['bill']) && $_FILES['bill']['error'] == UPLOAD_ERR_OK) {
            ...
            $sql = "UPDATE `telephone` SET `Bill` = '$fileNameBill' WHERE `ID` = '$id'";
            $result = mysqli_query($con, $sql);
        }
        ...
        $sql = "UPDATE `telephone` SET `Date` = '$date',
                                    `Brand` = '$brand',
                                    `Amount` = '$amount',
                                    `Price` = '$price',
                                    `By` = '$name',
    ...
    if(isset($_POST['delete'])) {
        ...
        $targetDir = "images/telephone/$detail-$date/";
