<?php
    ...
    if(isset($_POST['add'])) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['more_pic'])) {
            ...
            $targetDir = "images/elevator/$detail-$date/more_pictures/";
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['quotation'])) {
            ...
            $targetDir = "images/elevator/$detail-$date/quotation/";
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['bill'])) {
            ...
            $targetDir = "images/elevator/$detail-$date/bill/";
        ...
        $sql = "INSERT INTO `elevator`(`Date`, `Detail`, `Note`, `Quotation`, `Bill`, `By`, `Lastestdate`, `Time`) VALUES ('$date','$detail','$note','$fileNameQuotation','$fileNameBill','$name','$current_date','$current_time')";
    ...
    if(isset($_POST['edit'])) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['quotation']) && $_FILES['quotation']['error'] == UPLOAD_ERR_OK) {
            ...
            $sql = "UPDATE `elevator` SET `Quotation` = '$fileNameQuotation' WHERE `ID` = '$id'";
            $result = mysqli_query($con, $sql);
        }
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['bill']) && $_FILES['bill']['error'] == UPLOAD_ERR_OK) {
            ...
            $sql = "UPDATE `elevator` SET `Bill` = '$fileNameBill' WHERE `ID` = '$id'";
            $result = mysqli_query($con, $sql);
        }
        ...
        $sql = "UPDATE `elevator` SET `Date` = '$date',
                                    `Note` = '$note',
                                    `By` = '$name',
    ...
    if(isset($_POST['delete'])) {
        ...
        $targetDir = "images/elevator/$detail-$date/";

        deleteDirectory($targetDir);

        $sql = "DELETE FROM `elevator` WHERE `ID` = '$id'";
        $result = mysqli_query($con, $sql);
